...
\begin{itemize}
    ...
    system RAM and VRAM before loading to memory, avoiding out-of-memory errors.
\end{itemize}
The codebase is available at \url{https://github.com/briansebzhou/bbscore_public}.
...
\texttt{TVSD} image to grayscale and repeat it across 50 frames as input. DINOv2 was
...
\begin{itemize}
    \item \textbf{conv0}: The first layer applies eight convolutions over the
    50 temporal frames (treated as input channels) followed by
    Batch Normalization and a ReLU activation.
    \item \textbf{conv1}: The second layer applies sixteen 2D convolutions followed by
...
the layer naming used throughout this report.
\begin{figure}[tbp]
    \centering
